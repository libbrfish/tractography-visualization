...
% Add folders to path
    ...
    addpath(fullfile(thisDir, 'Geometry/Partition/eq_partitions'));
    addpath(fullfile(thisDir, 'Geometry/Partition/eq_point_set_props'));
    addpath(fullfile(thisDir, 'Geometry/Partition/eq_region_props'));
    addpath(fullfile(thisDir, 'Geometry/Partition/eq_utilities'));
    addpath(fullfile(thisDir, 'Viewpoint'));
    addpath(fullfile(thisDir, 'Codegen'));
    ...
    % folder
    p = 0:10:100;
    [fib, ind] = filter_nerve(filename, pix_NF, E_NF, p, out_dir);
